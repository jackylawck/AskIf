...
// 🔑 提取 URL Hash 攜帶的即焚密碼，存入 sessionStorage 後立即抹除 URL Hash，防止截圖外洩
...
// 防禦式更新 DOM，防止 null 報錯
const roomLabelEl = document.getElementById('room-id-label');
if (roomLabelEl) {
...
if (openDisplayBtn) {
  openDisplayBtn.href = `./display.html?room=${encodeURIComponent(roomId)}`;
}
